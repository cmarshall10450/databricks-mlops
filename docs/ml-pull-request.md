...
Opening a pull request will trigger a[workflow](../.github/workflows/databricks-mlops-demo-run-tests.yml) 
...
* [Staging workspace registered model](https://adb-3791282273192675.15.azuredatabricks.net#mlflow/models/staging-databricks-mlops-demo-model)
* [Prod workspace registered model](https://adb-3791282273192675.15.azuredatabricks.net#mlflow/models/prod-databricks-mlops-demo-model)
