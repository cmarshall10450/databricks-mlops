...
```
databricks-mlops-demo         <- Root directory. Both monorepo and polyrepo are supported.
│
├── databricks_mlops_demo       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
